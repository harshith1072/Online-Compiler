...
//             {/* The left panel now uses flex-1 and flex-col to allow inner content to scroll */}
//             <div className="question-section flex-1 p-6 bg-white rounded-xl shadow-lg m-2 border border-gray-200 flex flex-col">
//                 {/* The inner 'Question' div is now the one that overflows and scrolls */}
//                 <div className="Question flex-1 overflow-y-auto"> 
...
//                 </div>
//             </div>
//             {/* The right panel also uses flex-1 to ensure it takes up equal space */}
//             <div className="editor-section flex-1 p-6 m-2 bg-white rounded-xl shadow-lg border border-gray-200">
//                 <Editor />
//             </div>
//         </div>
//     );
