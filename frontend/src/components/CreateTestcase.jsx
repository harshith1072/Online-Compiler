...
//         const isValid = testcases.every(tc => tc.input.trim() !== '' && tc.expected_output.trim() !== '');
//         if (!isValid) {
...
//                 const response = await fetch('http://localhost:9000/testcases', {
//                     method: 'POST',
//                     headers: {
...
//                 setTestcases([{ problem_id: id, input: '', expected_output: '' }]); // Clear form
//             } else {
...
//                     <div>
//                         <label htmlFor="problem_id" className="block text-sm font-medium text-gray-700 mb-1">Problem ID</label>
//                         <input
//                             type="text"
//                             id="problem_id"
//                             name="problem_id"
//                             value={id}
//                             readOnly
//                             className="w-full p-3 bg-gray-200 border border-gray-300 rounded-lg shadow-sm placeholder-gray-500 text-gray-600 cursor-not-allowed"
//                         />
//                     </div>
